...
public class Verify_EmployeeDashboard extends Functions{
	...
	@Test(dataProvider = "TestCase_017")

	public void TestCase_017(String User,String Pwd,String Role) {
		...
		try
		{
			...
			//Click on the Remedy Management
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("lnk_RM"),"");
			//Click on theEmployee Dash board
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("EDashboard_lnk"),"");
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("TCust"),Object.getProperty("label1"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("TLoans"),Object.getProperty("label2"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("TEst"),Object.getProperty("label3"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("G60days"),Object.getProperty("label4"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("G90days"),Object.getProperty("label5"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("G120days"),Object.getProperty("label6"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("G365days"),Object.getProperty("label7"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("OApeeals"),Object.getProperty("label8"),sTestCaseName);
			//To verify Dash board values
			ExcecuteFunction("VerifyDashboard",User,"",Object.getProperty("Repurchase"),Object.getProperty("label9"),sTestCaseName);
			//To logout from the application
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("btn_Logout"),"");

			//If any of the above verifyDashboard function fails ,then write in Excel "Not Validated".
			String []FunResult1 = new String[Functions.AlFunResult1.size()];
			System.out.println(Functions.AlFunResult1);
			//System.out.println(Functions.AlFunResult1.size());
			AlFunResult1.toArray(FunResult1);
			if(ArrayUtils.contains(FunResult1, "Fail"))
			{
				Utils.WriteResultUtility(BaseClass.TestCaseListExcelOne, "TestCases", "Value" ,sTestCaseName, "Not Validated");
			}
			else
			{
				Utils.WriteResultUtility(BaseClass.TestCaseListExcelOne, "TestCases", "Value" ,sTestCaseName, "Validated");
			}
			
			
			//If any of the above function fails ,then flag will be set as true.
			String []FunResult = new String[Functions.AlFunResult.size()];
			System.out.println(Functions.AlFunResult);
			//System.out.println(Functions.AlFunResult.size());
			AlFunResult.toArray(FunResult);
			if(ArrayUtils.contains(FunResult, "Fail"))
			{
				Testfail=true;
			}
			else
	...
	@DataProvider
	public Object[][] TestCase_017() throws Exception{
