...
public class Verify_RMlinkAccess extends Functions{
	...
	@Test(dataProvider = "TestCase_016")

	public void TestCase_016(String User,String Pwd,String Role) {
		...
		try
		{
			...
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("QCIMNavigation"),"");
			//To Click on the Pipeline tab
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("RemedyMgmtOption"),"");
			//To verify Blank values in Column
			ExcecuteFunction("VerifyRMlinkaccess",User,"","",Object.getProperty("RMTitle"),sTestCaseName);
	...
	@DataProvider
	public Object[][] TestCase_016() throws Exception{
