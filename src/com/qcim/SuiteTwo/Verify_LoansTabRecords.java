...
public class Verify_LoansTabRecords extends Functions{
	...
	@Test(dataProvider = "TestCase_004")

	public void TestCase_004(String User,String Pwd,String Role) {
		...
		try
		{
			...
			ExcecuteFunction("Verifyrecords",Object.getProperty("Loans_Records"),Param.getProperty("Loan_records"),sTestCaseName,Object.getProperty("LoansTab"),"");
	...
	@DataProvider
	public Object[][] TestCase_004() throws Exception{
