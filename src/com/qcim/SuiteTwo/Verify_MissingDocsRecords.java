...
public class Verify_MissingDocsRecords extends Functions{
	...
	@Test(dataProvider = "TestCase_005")

	public void TestCase_005(String User,String Pwd,String Role) {
		...
		try
		{
			...
			ExcecuteFunction("Verifyrecords",Object.getProperty("Missing_Records"),Param.getProperty("MissingDocs_records"),sTestCaseName,Object.getProperty("MissingDocs"),"");
	...
	@DataProvider
	public Object[][] TestCase_005() throws Exception{
