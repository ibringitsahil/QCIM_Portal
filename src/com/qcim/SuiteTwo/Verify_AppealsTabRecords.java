...
public class Verify_AppealsTabRecords extends Functions{
	...
	@Test(dataProvider = "TestCase_007")

	public void TestCase_007(String User,String Pwd,String Role) {
		...
		try
		{
			...
			ExcecuteFunction("Verifyrecords",Object.getProperty("Appeals_Records"),Param.getProperty("Appeals_records"),sTestCaseName,Object.getProperty("Appeals"),"");
	...
	@DataProvider
	public Object[][] TestCase_007() throws Exception{
