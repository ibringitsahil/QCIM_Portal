...
public class Verify_IncompleteDocsRecords extends Functions{
	...
	@Test(dataProvider = "TestCase_006")

	public void TestCase_006(String User,String Pwd,String Role) {
		...
		try
		{
			...
			//To Click on the Incomplete Docs tab
			...
			ExcecuteFunction("Verifyrecords",Object.getProperty("Incomplete_Records"),Param.getProperty("IncompleteDocs_records"),sTestCaseName,Object.getProperty("IncompleteDocs"),"");
	...
	@DataProvider
	public Object[][] TestCase_006() throws Exception{
