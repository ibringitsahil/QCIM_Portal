...
public class Verify_SiteAvailability extends Functions{
	...
	public void checkCaseToRun() throws Exception{
		...
		sTestCaseName = this.getClass().getSimpleName();            //returning Verify_SiteAvailability
	...
	@Test(dataProvider = "TestCase_001")

	public void TestCase_001(String User,String Pwd,String Role) {
	...
	@DataProvider
	public Object[][] TestCase_001() throws Exception{
