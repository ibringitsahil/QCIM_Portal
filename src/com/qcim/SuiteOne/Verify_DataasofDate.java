...
public class Verify_DataasofDate extends Functions{
	...
	@Test(dataProvider = "TestCase_002")

	public void TestCase_002(String User,String Pwd,String Role) {
		...
		try
		{
			...
			ExcecuteFunction("VerifyDate",User,Object.getProperty("lable_Dataasofdate"),sTestCaseName,Param.getProperty("Datadate"),"");
	...
	@DataProvider
	public Object[][] TestCase_002() throws Exception{
