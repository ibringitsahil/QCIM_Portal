...
public class Verify_ColIncomDocDesc extends Functions{
	...
	@Test(dataProvider = "TestCase_010")

	public void TestCase_010(String User,String Pwd,String Role) {
		...
		try
		{
			...
			//To sort the Column
			ExcecuteFunction("SortColumn",User,"","",Object.getProperty("Col_DescofIncomDocs"),"");
			//To verify Blank values in Column
			ExcecuteFunction("VerifyBlank",User,Object.getProperty("FirstRowIncom"),Object.getProperty("Col_DescofIncomDocs"),sTestCaseName,"");
	...
	@DataProvider
	public Object[][] TestCase_010() throws Exception{
