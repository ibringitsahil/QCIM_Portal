...
public class Verify_ColMissDocDesc extends Functions{
	...
	@Test(dataProvider = "TestCase_008")

	public void TestCase_008(String User,String Pwd,String Role) {
		...
		try
		{
			...
			//To sort the Column
			ExcecuteFunction("SortColumn",User,"","",Object.getProperty("Col_DescofMissDocs"),"");
			//To verify Blank values in Column
			ExcecuteFunction("VerifyBlank",User,Object.getProperty("FirstRow"),Object.getProperty("Col_DescofMissDocs"),sTestCaseName,"");
	...
	@DataProvider
	public Object[][] TestCase_008() throws Exception{
