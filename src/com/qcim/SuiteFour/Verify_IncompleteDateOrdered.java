...
public class Verify_IncompleteDateOrdered extends Functions{
	...
	@Test(dataProvider = "TestCase_013")

	public void TestCase_013(String User,String Pwd,String Role) {
		...
		try
		{
			...
			//To Click on the Missing Docs tab
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("IncompleteDocs"),"");
			//To verify Blank values in Column
			ExcecuteFunction("VerifyBusinessDays",User,Object.getProperty("Col_IncDate_Row"),Object.getProperty("Col_IncOrdDate"),sTestCaseName,Object.getProperty("lable_Dataasofdate"));
	...
	@DataProvider
	public Object[][] TestCase_013() throws Exception{
