...
public class Verify_DocUploadtab extends Functions{
	...
	@Test(dataProvider = "TestCase_011")

	public void TestCase_011(String User,String Pwd,String Role) {
		...
		try
		{
			...
			//To click on Document Upload Tab
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("DocUploadTab"),"");

			//To DoubleClick on the Column
			ExcecuteFunction("DoubleClick",User,Object.getProperty("Col_SubDate"),"","","");
			ExcecuteFunction("VerifyDate",User,Object.getProperty("Col_SubDate_Row"),sTestCaseName,Param.getProperty("SubDate"),"");
	...
	@DataProvider
	public Object[][] TestCase_011() throws Exception{
