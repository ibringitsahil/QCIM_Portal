...
public class Verify_LoansTab_1stFileReqDate extends Functions{
	...
	@Test(dataProvider = "TestCase_009")

	public void TestCase_009(String User,String Pwd,String Role) {
		...
		try
		{
			...
			ExcecuteFunction("ClickbyXpath",User,"","",Object.getProperty("LoansTab"),"");
			//To verify Blank values in Column
			ExcecuteFunction("VerifyBusinessDays",User,Object.getProperty("LoansFirstRow"),Object.getProperty("Col_1stFileReqDate"),sTestCaseName,Object.getProperty("lable_Dataasofdate"));
	...
	@DataProvider
	public Object[][] TestCase_009() throws Exception{
